...
//ako uvdis neku promenljivu npr let par=document.querySelector('p'); kad posle hoces decu njegovu da
...
div1.innerText='neki tekst';
document.body.appendChild(div1);//izgleda da se body dodaje posto je on roditelj;
...
li1.innerText=`prva stavka`;

let li2=document.createElement('li');
li2.innerText=`druga stavka`;

let li3=document.createElement('li');
li3.innerText=`treci stavka`;

let div11=document.getElementById('lista');
div11.appendChild(lista);
...
let pom=document.createElement('li');
pom.innerText='zamenjeno';
lista.replaceChild(pom,li2);
