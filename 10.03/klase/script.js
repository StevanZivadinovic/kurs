...
let film1 = new FilmGS("Titanik", "James Cameron", 1700);//ovde sam promenio klasu iz Film u FilmGS
let film2 = new FilmGS("Ko to tamo peva", "Slobodan Sijan", 1980);
film1.stampaj();
film2.stampaj();
console.log(film1.naslov);
film1.stampaj();
let p1 = new PacijentGS("Pera Peric", 1.74, 74);//ovde sam isto promenio klasu iz Pacijent u PacijentGS
let p2 = new PacijentGS("Laza Lazic", 1.80, 40);
