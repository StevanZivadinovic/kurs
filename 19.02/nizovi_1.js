...
let brojElemenataKojiPocinjuSlovom=(niz,slovo)=>
{
...

	{
		...
		if(niz[i].includes('c',0) || niz[i].includes('a',0))
...
console.log(brojElemenataKojiPocinjuSlovom(['aaa','bbb','ccc'], 'a'));
...
let b=[-7,-5,-9];
let c=[];//ovo moramo odmah da uvedemo, prazan niz, da bi imao gde da uvdem elemente
