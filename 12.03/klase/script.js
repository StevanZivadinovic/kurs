...
//Napraviti funkciju srednjaVisina kojoj se prosleđuje niz pacijanata a
//koja određuje i vraća srednju visinu pacijenata.
...
if(Math.abs(prosek-a.prosecna())<najblizi){
...
let oc=[1,1,1,8.3,4.001,1,1,9,9,5,5,5]; //neki random niz za koji ce da nadjemo koji broj se najcesce pojavljivao

    let najcesca=oc[0];
    let ponavljanje=0;
    let maxPonavljanje=0;
